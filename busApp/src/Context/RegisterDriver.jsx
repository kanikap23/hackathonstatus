...
function RegisterDriver() {
  ...
  return (
    <div className="flex h-[100vh] w-[100vw] overflow-hidden font-comic-neue">
      <div className="bg-[#F5FDFF] h-[100vh] w-[35%] flex flex-col items-center p-4">
        ...
        {page === "Register" ? (
          <div className="mt-[2vh]">
            <div className="flex flex-col items-center space-y-[4vh]">
              ...
              <div className="flex flex-col items-center h-[50px] w-[290px]">
                <span className="text-[23px] mr-[6px]">{"hello guys"}</span>
                <input
                  className="text-[#5F5E5E] border-none"
                  type="file"
                  accept="image/*"
                  onChange={(e) => {
              ...
              <div className="flex flex-col items-center space-y-5">
                ...
                {isLoading ? (
                  ...
                  <button
                    className="px-8 py- w-[200px] rounded-full font-bold  text-white bg-[#E93F4B] hover:text-gray-300 text-[20px]"

        ...
        <div className="rounded-[40px] bg-[#E93F4B] w-[500px] h-[500px] flex flex-col justify-center items-center gap-[50px]">
          <div className={" flex mt-[-20%] ml-[60%] gap-[5px]"}>
            ...
            >
              ...
              />
              <div className="toggle-bg bg-[#FAD1D4] border-2 border-[#FAD1D4] h-6 w-[60px] rounded-full"></div>
            </label>
          </div>
          <input
            className={"text-black w-[70%] h-[40px] rounded-[12px] p-3"}
            type="text"
            value={name}
          ...
          <select
            className={"w-[70%] h-[40px] rounded-[12px] p-2"}
            value={route}
          ...
          <button
            className={
              "absolute mt-[22%] w-[150px] h-[40px] border-2 rounded-[12px] bg-[#E01A27] text-white"
            }
